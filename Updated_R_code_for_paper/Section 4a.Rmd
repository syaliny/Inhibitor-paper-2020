...
setwd("/Volumes/Elements/Inhibitor_paper/Section4a/")
#Bacteria
...
#Use the B_sigOTU_T2.csv and edit genus names so it is more meaningful, remove first col of OTu names from B_sigOTU_T2.csv and edit phylum column of proteobacteria to Alpha,Beta,Delta and Gamma, remove first OTu column
B_Subset_sig_OTU_T2_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T2_edited.csv")
...
B_T2_plot<-ggplot(B_All_sig_OTU_Gen_T2_df, 
  ...
  ylab("Abundance")+
 theme(axis.text.x = element_text(angle = 45, hjust = 1,size=30),strip.text = element_text(size=30),axis.text.y = element_text(size=30), axis.title=element_text(size=35,face="bold"),legend.text=element_text(size=35),legend.key.size=unit(1.00,"cm"),legend.title=element_text(size=35,face="bold"))+
...
B_Subset_sig_OTU_T3_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T3_edited.csv")
...
#Use the B_sigOTU_T2.csv and edit genus names so it is more meaningful, remove first col of OTu names from B_sigOTU_T2.csv and edit phylum column of proteobacteria to Alpha,Beta,Delta and Gamma
B_Subset_sig_OTU_T4_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T4_edited.csv")
...
#Use the B_sigOTU_T2.csv and edit genus names so it is more meaningful, remove first col of OTu names from B_sigOTU_T2.csv and edit phylum column of proteobacteria to Alpha,Beta,Delta and Gamma
B_Subset_sig_OTU_T5_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T5_edited.csv")
...
#Use the B_sigOTU_T2.csv and edit genus names so it is more meaningful, remove first col of OTu names from B_sigOTU_T2.csv and edit phylum column of proteobacteria to Alpha,Beta,Delta and Gamma
B_Subset_sig_OTU_T6_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T6_edited.csv")
...
#Use the B_sigOTU_T2.csv and edit genus names so it is more meaningful, remove first col of OTu names from B_sigOTU_T2.csv and edit phylum column of proteobacteria to Alpha,Beta,Delta and Gamma
B_Subset_sig_OTU_T7_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/B_sigOTU_T7_edited.csv")
...
#import csv with changed taxa names, have to import this file manually
F_Subset_sig_OTU_T3_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/F_sigOTU_T3_edited.csv")

F_Subset_sig_OTU_T3_genus_edited=F_sigOTU_T3_edited
...
FungiGrowthrescolourlistT3 <- c(unc_Pleosporales="#993404")
...
ggsave("/Volumes/Elements/Inhibitor_paper/Section4a/FT3.pdf",width=5,height=3)
...
#import csv with changed taxa names, have ti import manually
F_Subset_sig_OTU_T7_genus_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section4a/F_sigOTU_T7_edited.csv")

F_Subset_sig_OTU_T7_genus_edited=F_sigOTU_T7_edited
...
F_T7_plot<-ggplot(F_All_sig_OTU_Gen_T7_df, 
  ...
  ylab("Abundance")+
 theme(axis.text.x = element_text(angle = 45, hjust = 1,size=12),strip.text = element_text(size=12),axis.text.y = element_text(size=12), axis.title=element_text(size=12,face="bold"),legend.text=element_text(size=12),legend.title=element_text(size=12,face="bold"))+
 scale_fill_manual(values=c("lightblue","#662506"))+
facet_wrap(.~Genus,drop = TRUE,scales = "free_y",ncol=4,labeller = label_wrap_gen(width = 10, multi_line=TRUE))
             
F_T7_plot+scale_x_discrete(labels=c("Negative Control" = "NC", "Positive Control" = "PC",
                              "Antibacterial" = "AB","Antifungal"="AF","Antibacterial+Antifungal"="AB+AF"))

ggsave("/Volumes/Elements/Inhibitor_paper/Section4a/FT7.pdf",width=8,height=3)
```
