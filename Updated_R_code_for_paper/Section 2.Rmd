...
setwd("/Volumes/Elements/Inhibitor_paper/Section2")
...
#write csv
write.csv(AM_summ_obs_Bacteria, file="/Volumes/Elements/Inhibitor_paper/Section2/ObservedBact_table.csv")
...
ObservedR_Bacteria_plot<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Bacteria,Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Bacteria, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_obs_Bacteria,Treatment %in% c("Positive Control","Negative Control")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))

#Rename y label
ObservedR_Bacteria_plot=ObservedR_Bacteria_plot+labs(y="OTU Richness")
ObservedR_Bacteria_plot
...
#write csv
write.csv(AM_summ_obs_Fungi, file="/Volumes/Elements/Inhibitor_paper/Section2/ObservedFungi_table.csv")
...
ObservedR_Fungi_plot<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Fungi,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Fungi,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Fungi, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Fungi, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_obs_Fungi,Treatment %in% c("Positive Control","Negative Control")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))


#Rename y label
ObservedR_Fungi_plot=ObservedR_Fungi_plot+labs(y="OTU Richness")
ObservedR_Fungi_plot

##ggarrange
#combined_richness_BF=ggarrange(ObservedR_Bacteria_plot,ObservedR_Fungi_plot)

#pdf("Fig3.pdf", height = 8, width = 22)
#combined_richness_BF
#dev.off()


combined_richness_BF=ggarrange(ObservedR_Bacteria_plot,ObservedR_Fungi_plot,ncol=2,nrow=1)
...
ggsave("/Volumes/Elements/Inhibitor_paper/Section2/Fig3.pdf",width=18,height=5,units ="cm", device="pdf") # 18 and 12 is good  #use this if landscape plot  # 16 and 10 is good

```

#Modified Fig 3 for graphical abstract
```{r}
#Write csv for AM_summ_obs_Bacteria and AM_summ_obs_Fungi and rename treatments, for Positive control rename to urea, Negative control rename to no urea and inhibitors just add urea in fron of inhibitors (ex: Urea+Antibacterial)
write.csv(AM_summ_obs_Bacteria,"/Volumes/Elements/Inhibitor_paper/Section2/AM_summ_obs_Bacteria.csv")
write.csv(AM_summ_obs_Fungi,"/Volumes/Elements/Inhibitor_paper/Section2/AM_summ_obs_Fungi.csv")

#read edited files
AM_summ_obs_Bacteria_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section2/AM_summ_obs_Bacteria_edited.csv")

AM_summ_obs_Fungi_edited=read.csv("/Volumes/Elements/Inhibitor_paper/Section2/AM_summ_obs_Fungi_edited.csv")

#Change day to factor
AM_summ_obs_Bacteria_edited$Day <- as.factor(AM_summ_obs_Bacteria_edited$Day) 

#Bacteria
ObservedR_Bacteria_plot_GA<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Bacteria_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea","No Urea")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))

#Rename y label
ObservedR_Bacteria_plot_GA=ObservedR_Bacteria_plot_GA+labs(y="OTU Richness")
ObservedR_Bacteria_plot_GA



#Fungal
#Change day to factor
AM_summ_obs_Fungi_edited$Day <- as.factor(AM_summ_obs_Fungi_edited$Day) 
pd<-position_dodge(0.1)
ObservedR_Fungi_plot_GA<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Fungi_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Fungi_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea","No Urea")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))


#Rename y label
ObservedR_Fungi_plot_GA=ObservedR_Fungi_plot_GA+labs(y="OTU Richness")
ObservedR_Fungi_plot_GA



combined_richness_BF_GA=ggarrange(ObservedR_Bacteria_plot_GA,ObservedR_Fungi_plot_GA,ncol=2,nrow=1)

ggsave("/Volumes/Elements/Inhibitor_paper/Section2/Graphical_abstract.pdf",width=18,height=5,units ="cm", device="pdf")
...
```{r}
#Bacteria
ObservedR_Bacteria_plot_GA<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge", alpha=0.85)+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Bacteria_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("dotdash","solid")) + geom_errorbar(data=subset(AM_summ_obs_Bacteria_edited,Treatment %in% c("Urea","No Urea")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","red"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))
...
AM_summ_obs_Fungi_edited$Day <- as.factor(AM_summ_obs_Fungi_edited$Day) 
pd<-position_dodge(0.1)
ObservedR_Fungi_plot_GA<-ggplot()+geom_errorbar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea+Antibacterial","Urea+Antifungal", "Urea+Antibacterial+Antifungal")), aes(x = Day, y = OTU_Richness, fill=Treatment), stat ="identity", position= "dodge", alpha=0.85)+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_obs_Fungi_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness, color=Treatment))+ geom_line(data=subset(AM_summ_obs_Fungi_edited, Treatment %in% c("Urea","No Urea")), aes(x = Day, y = OTU_Richness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("dotdash","solid")) + geom_errorbar(data=subset(AM_summ_obs_Fungi_edited,Treatment %in% c("Urea","No Urea")),mapping=aes(x=Day,ymin=OTU_Richness-se, ymax=OTU_Richness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","red"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7), legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))
...
ggsave("/Volumes/Elements/Inhibitor_paper/R code/New_code/Section2/3MT_fig.pdf",width=18,height=5,units ="cm", device="pdf")
...
#write csv
write.csv(AM_summ_shan_Bacteria, file="/Volumes/Elements/Inhibitor_paper/Section2/ShannonBact_table.csv")
...
Shannon_Bacteria_plot<-ggplot()+geom_errorbar(data=subset(AM_summ_shan_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=Diversity-se, ymax=Diversity+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_shan_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")), aes(x = Day, y = Diversity, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_shan_Bacteria, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Diversity, color=Treatment))+ geom_line(data=subset(AM_summ_shan_Bacteria, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Diversity,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_shan_Bacteria,Treatment %in% c("Positive Control","Negative Control")),mapping=aes(x=Day,ymin=Diversity-se, ymax=Diversity+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle =45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7),legend.position="none", legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))

#Rename y label
Shannon_Bacteria_plot=Shannon_Bacteria_plot+labs(y="OTU Diversity")
Shannon_Bacteria_plot
...
#write csv
write.csv(AM_summ_shan_Fungi, file="/Volumes/Elements/Inhibitor_paper/Section2/ShannonFungi_table.csv")
...
#write csv
write.csv(AM_summ_pielou_Bacteria, file="/Volumes/Elements/Inhibitor_paper/Section2/EvennessBact_table.csv")
...
Pielou_Bacteria_plot<-ggplot()+geom_errorbar(data=subset(AM_summ_pielou_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=Evenness-se, ymax=Evenness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_pielou_Bacteria,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")), aes(x = Day, y = Evenness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_pielou_Bacteria, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Evenness, color=Treatment))+ geom_line(data=subset(AM_summ_pielou_Bacteria, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Evenness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_pielou_Bacteria,Treatment %in% c("Positive Control","Negative Control")),mapping=aes(x=Day,ymin=Evenness-se, ymax=Evenness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5,angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7, face="bold"),legend.text=element_text(size=7),legend.position="none",legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))

Pielou_Bacteria_plot=Pielou_Bacteria_plot+labs(y="OTU Evenness")
Pielou_Bacteria_plot
...
#write csv
write.csv(AM_summ_pielou_Fungi, file="/Volumes/Elements/Inhibitor_paper/Section2/EvennessFungi_table.csv")
...
#Pielou Fungi plot
Pielou_Fungi_plot<-ggplot()+geom_errorbar(data=subset(AM_summ_pielou_Fungi,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")),mapping=aes(x=Day,ymin=Evenness-se, ymax=Evenness+se,group=Treatment), width=0.5, size=.3,colour="black", position=position_dodge(width=0.8))+geom_bar(data=subset(AM_summ_pielou_Fungi,Treatment %in% c("Antibacterial","Antifungal", "Antibacterial+Antifungal")), aes(x = Day, y = Evenness, fill=Treatment), stat ="identity", position= "dodge")+ scale_fill_manual(name="Treatment",values=c("#F0E442","#0072B2","#009E73"))+ geom_point(size=0.5,data=subset(AM_summ_pielou_Fungi, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Evenness, color=Treatment))+ geom_line(data=subset(AM_summ_pielou_Fungi, Treatment %in% c("Positive Control","Negative Control")), aes(x = Day, y = Evenness,colour=Treatment, group=Treatment,linetype=Treatment),lwd=0.5) + scale_linetype_manual(values=c("solid","dotdash")) + geom_errorbar(data=subset(AM_summ_pielou_Fungi,Treatment %in% c("Positive Control","Negative Control")),mapping=aes(x=Day,ymin=Evenness-se, ymax=Evenness+se,group=Treatment), width=0.4, size=.3,colour="black", position=position_dodge(width=0.01))+theme_light()+scale_color_manual(values=c("#000000","#999999"))+ theme(axis.text.x = element_text(hjust = 1,size=5, angle=45),strip.text = element_text(size=7),axis.text.y = element_text(size=5), axis.title=element_text(size=7,face="bold"),legend.text=element_text(size=7),legend.key.size = unit(0.25, "cm"),legend.title=element_text(size=7,face="bold"))

Pielou_Fungi_plot=Pielou_Fungi_plot+labs(y="OTU Evenness")
Pielou_Fungi_plot
```

#ggarrange for diversity and evenness
```{r}

combined_div_evenness_BF=ggarrange(Shannon_Bacteria_plot,Shannon_Fungi_plot,Pielou_Bacteria_plot,Pielou_Fungi_plot,ncol=2,nrow=2, widths =c(1,1.5))
combined_div_evenness_BF

ggsave("/Volumes/Elements/Inhibitor_paper/Section2/FigS3.pdf",width=17,height=8,units ="cm", device="pdf")

#pdf("FigS3.pdf", height = 10, width = 20)
#combined_div_evenness_BF
#dev.off()
```
...
#write csv
write.csv(Posthoc_Bact_Obs$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Bact_Obs2.csv")
...
#write csv
write.csv(Posthoc_Bact_Shan$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Bact_Shan2.csv")
...
#write csv
write.csv(Posthoc_Bact_Even$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Bact_Even2.csv")
...
#write csv
write.csv(Posthoc_Fungi_Obs$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Fungi_Obs2.csv")
...
#write csv
write.csv(Posthoc_Fungi_Shan$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Fungi_Shan2.csv")
...
#write csv
write.csv(Posthoc_Fungi_Even$res, file = "/Volumes/Elements/Inhibitor_paper/Section2/PosthocDunn_Fungi_Even2.csv")
